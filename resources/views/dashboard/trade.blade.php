                            ...
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text pl-3 pr-0" id="basic-addon1">
                                        <img src="{{asset('/img/coins/eth.svg')}}" alt="" width="15">
                                    </span>
                                </div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-5 mt-2">
                            <div class="d-flex align-items-center tFIRST">
                                <img src="{{asset('/img/profile/avatar-1.jpg')}}" class="img-fluid rounded-pill trader__profile--image" alt="">
                                <div>
                        ...
                        <div class="col-12 col-sm-12 col-md-12 col-lg-7 mt-2">
                            <div class="d-flex align-items-center">
                                <img src="{{asset('/img/profile/avatar-2.jpg')}}" class="img-fluid rounded-pill trader__profile--image" alt="">
                                <div class="ml-2">
